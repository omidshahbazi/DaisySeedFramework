...
#define USBD_MANUFACTURER_STRING    USB_ADUIO_MANUFACTURER_STRING //"Electrosmith"

/* Internal FS connector — the one on the Daisy Seed board */
#define USBD_PID_FS                 USB_ADUIO_PID //0x5741
#define USBD_PRODUCT_STRING_FS      USB_ADUIO_PRODUCT_STRING //"JamMate Audio In"
...
#define USBD_PID_HS                 USB_ADUIO_PID + 1 //
#define USBD_PRODUCT_STRING_HS      USB_ADUIO_PRODUCT_STRING //"JamMate Audio In HS"
