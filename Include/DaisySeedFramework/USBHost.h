...
//	{}
//
//	virtual void Initialize(uint16 BufferSize, IUSBInterface::USBInterfaces Interface = IUSBInterface::USBInterfaces::External)
//	{
//		m_USBInterface->Start(Interface);
//
//		new (&m_Buffer) BufferType(Memory::Allocate<BufferType::ItemType>(BufferSize, true));
//
